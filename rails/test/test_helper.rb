...
class CapybaraIntegrationTest < ActionDispatch::IntegrationTest
  ...
  # Because the “test ‘saving’ do” step is currently being skipped, 
  # the index.html file generated by the tests must be deleted
  Minitest.after_run do
    path = Rails.root.join("test/fixtures/files/index.html")
